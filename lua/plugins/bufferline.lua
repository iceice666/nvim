return {
	...
	config = function()
		...
		mapx.group({ silent = true }, function()
			...
			mapx.nnoremap("<leader>q", "<cmd>Neotree close<cr><cmd>bdelete %<cr>", "Buf: Close current buffer")

			mapx.nnoremap("<leader>bo", "<cmd>BufferLineCloseOthers<CR>", "Buf: Close all except current")
			mapx.nnoremap(
				"<leader>ba",
